...
public class Panel extends JPanel {
	...
	// Tạo mê cung
	MazeGenerator mazeGenerator = new MazeGenerator(maxCol, maxRow);
	...
	public Panel() {
		...
		setBorder(null);
		GridLayout gridLayout = new GridLayout(maxRow, maxCol);
		...
		mazeInBinary = mazeGenerator.getBinaryMaze();
	...
	private void getCost(Cell cell) {
		...
		if (cell != startCell && cell != goalCell) {
			// cell.setText("<html>g: " + cell.gCost + " h: " + cell.hCost + "<br>f: " +
			// cell.fCost);
		}
	}
	...
	public void aStar() {
		while (!goalReached) {
			...
			for (int i = 0; i < openList.size(); i++) {
				...
				// Kiểm tra các vị trí trong danh sách mở có vị trí nào có chi phí fCost tốt hơn
				// không
	...
	// Phương thức quay lui để hiển thị con đường tốt nhất
